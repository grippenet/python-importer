...
class BaseFixedColumnSelector:

    def select(data_columns:List[str]):
        pass

class FixedColumnSelector(BaseFixedColumnSelector):
...
class PatternColumnSelector(BaseFixedColumnSelector):
